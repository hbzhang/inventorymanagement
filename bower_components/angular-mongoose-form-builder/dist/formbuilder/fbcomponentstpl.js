angular.module('componentshtmltemplate.templates', ['templates/htmls/label.html', 'templates/htmls/labelpopup.html', 'templates/htmls/checkbox.html', 'templates/htmls/checkboxpopup.html', 'templates/htmls/personnamepopup.html', 'templates/htmls/personname.html', 'templates/htmls/fbcomponents.html']);

angular.module("templates/htmls/label.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/htmls/label.html",
    "<div class=\"form-group\">\n" +
    "    <div class=\"col-sm-12\">\n" +
    "    <h4  id=\"{{formName+index}}\" class=\"help-block\" ng-class=\"{'fb-required':required}\">{{label}}</h4>\n" +
    "    <HR WIDTH=\"60%\" validator-group=\"{{formName}}\" id=\"{{formName+index}}\">\n" +
...
angular.module("templates/htmls/labelpopup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/htmls/labelpopup.html",
    "<form>\n" +
    "  <div class=\"form-group\">\n" +
