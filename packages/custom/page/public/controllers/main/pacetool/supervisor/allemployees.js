/**
 * Created by hbzhang on 11/15/16.
 */

angular.module('mean.page').controller('EmployeesController', ['$scope',
                        ...
                        Users.query({}, function(users1) {
                            _.each(users1, function(user1) {
                                ...
                                if (user1.attributes[0] && user.attributes[0] &&
                                    ...
                                    user.attributes[0]['Position Number'] === user1.attributes[0]['Supervisor Position Number ']) {
