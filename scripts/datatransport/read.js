...
function updateDatabase(data){
  ...
  var mapping = [];
    ...
    //http://stackoverflow.com/questions/8373905/when-to-close-mongodb-database-connection-in-nodejs
        ...
        for(var i=0 ; i<data.length ; i++){
            ...
            db.collection(collection).update({ email : data[i].email},
                                {$setOnInsert: { "name"     : data[i].name,
                                                 ...
                                                 "roles"    : "authenticated",
                                                 "salt" :  this.salt,
                                                  "hashed_password" :makepassword('123123123')
                                               },
