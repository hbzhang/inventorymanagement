...
angular.module('mean.admin').controller('FormPrivilegeController', ['$scope',
    'Global','createDialog','FormPrivilegeData','$rootScope','$http',
    'ModulesHelper','formtoaster',
    'PrivilegeURLItem','PrivilegeTestMode',
    'DataCommunication',
    function($scope, Global,createDialogService,FormPrivilegeData,$rootScope,
    ...
    $scope.my_data = FormPrivilegeData.item_privilege; //$scope.$parent.tree_data;
