...
angular.module('mean.page').controller('ReviewerApproveController', ['$scope','Global',
    'Restangular','Program','$location','$builder',
    '$validator','formtoaster','URLStateTrack','LocalStorageData','Users','UserinformationHelper',
    function($scope,Global,Restangular,Program,$location,
             $builder,$validator,
             formtoaster,URLStateTrack,LocalStorageData,Users,UserinformationHelper) {
        $scope.global = Global;
